...
export default function NewCollection() {
  return (
    <div className="relative w-full h-[400px] flex items-center justify-center bg-gray-200 mb-4 overflow-hidden">
      <img
      ...
      <div className="relative z-1 text-center p-4">
        <p className="text-lg text-gray-700">Novos drops toda semana</p>
